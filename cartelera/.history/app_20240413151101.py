...
from funciones import crea_diccionario_solo_anio
import os
...
diccionario_anio = crea_diccionario_solo_anio(cartelera)
...
@app.route("/anios")
def anio():
    return render_template("anio.html",dicc_anio=diccionario_anio)
