...
from funciones import crea_lista_anios
import os
...
lista_anios = crea_lista_anios(cartelera)
...
@app.route("/anios")
def anio():
    return render_template("anio.html", dicc_anios=diccionario_anios, list_anios=lista_anios)
